...
| **Kids' Learning Site Link** | The home screen and Settings both link out to the developer's free learning site for kids (arithmetic / shogi / stargazing). Shown only when the device language is Japanese, because the site is Japanese-only |
